...
def main():
    ...
    for filename in os.listdir(input_directory):
        if filename.endswith(".png"):
            ...
            # Article
            article = """
                <p>Explore this refined creation meticulously crafted 
                using Stable Diffusion technology.</p>
                <p><i>For a comprehensive understanding, review the associated generation data below. </i></p>
                <p>If you have inquiries or insights, we welcome your engagement on 
                <a href="https://twitter.com/ephergent">X</a>.</p>
                <p>Your appreciation for the intricacies of art is valued</p>
                </p>—Thank you for joining us on this visual journey.</p>
            """
